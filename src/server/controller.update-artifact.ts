...
export class UpdateArtifactController extends AbstractController<UpdateArtifactBodyParameters, ArtifactPathParameters, ArtifactDetail> {
  async handler({ bodyParams, pathParams }: RequestOptions<UpdateArtifactBodyParameters, ArtifactPathParameters>): Promise<ArtifactDetail> {
