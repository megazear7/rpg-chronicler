...
export class SearchContentfulEventsService extends AbstractService<z.infer<typeof SearchContentfulEventsBody>, NoPathParams, z.infer<typeof ContentfulEventReference>[]> {
