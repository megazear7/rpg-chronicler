...
import { completeContentfulStageController } from "./controller.complete-contentful-stage.js";
import { completeNotionStageController } from "./controller.complete-notion-stage.js";
...
import { rerunJobStageController } from "./controller.rerun-job-stage.js";
...
import { pauseJobController } from "./controller.pause-job.js";
import { resumeJobController } from "./controller.resume-job.js";
...
completeContentfulStageController.register(router);
completeNotionStageController.register(router);
...
pauseJobController.register(router);
resumeJobController.register(router);
restoreJobController.register(router);
regenerateBulletPointOutputController.register(router);
rerunJobStageController.register(router);
