      ...
      ? ((): TemplateResult => {
          switch (this.currentRoute!.name) {
            case RouteName.enum.home:
              ...
              `;
            case RouteName.enum.usage:
              return html`
                <div class="app-bar"></div>
                <rpg-chronicler-usage-page></rpg-chronicler-usage-page>
              `;
            case RouteName.enum.adventure_setup:
              return html`
                <div class="app-bar"></div>
                <rpg-chronicler-adventure-setup-page></rpg-chronicler-adventure-setup-page>
              `;
            ...
            case RouteName.enum.job:
              ...
              `;
            case RouteName.enum.job_stage:
              return html`
                <div class="app-bar"></div>
                <rpg-chronicler-job-stage-page></rpg-chronicler-job-stage-page>
              `;
